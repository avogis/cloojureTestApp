...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__29026__auto__,writer__29027__auto__,opt__29028__auto__){
return cljs.core._write.call(null,writer__29027__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__29910 = o;
(G__29910[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__29911__delegate = function (args){
...
while (G__29912__i < G__29912__a.length) {G__29912__a[G__29912__i] = arguments[G__29912__i + 0]; ++G__29912__i;}
  args = new cljs.core.IndexedSeq(G__29912__a,0);
} 
return G__29911__delegate.call(this,args);};
G__29911.cljs$lang$maxFixedArity = 0;
G__29911.cljs$lang$applyTo = (function (arglist__29913){
var args = cljs.core.seq(arglist__29913);
return G__29911__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__28408__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__28408__auto__){
var and__28408__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__28408__auto____$1){
var and__28408__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__28408__auto____$2)){
...
var G__29918 = jsprops;
(G__29918["defaultValue"] = value);

(G__29918["onChange"] = ((function (G__29918,v,value,on_change){
return (function (p1__29916_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29916_SHARP_);
});})(G__29918,v,value,on_change))
);
...
var vec__29923 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29923,(0),null);
var id = cljs.core.nth.call(null,vec__29923,(1),null);
var class$ = cljs.core.nth.call(null,vec__29923,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___29926 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___29926 == null)){
} else {
var key_29927 = temp__4661__auto___29926;
(jsprops["key"] = key_29927);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__29929 = (new reagent.impl.template.NativeWrapper());
(G__29929["name"] = c);
...
var len__29489__auto___29935 = arguments.length;
var i__29490__auto___29936 = (0);
while(true){
if((i__29490__auto___29936 < len__29489__auto___29935)){
args__29496__auto__.push((arguments[i__29490__auto___29936]));

var G__29937 = (i__29490__auto___29936 + (1));
i__29490__auto___29936 = G__29937;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29497__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29933){
var G__29934 = cljs.core.first.call(null,seq29933);
var seq29933__$1 = cljs.core.next.call(null,seq29933);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__29934,seq29933__$1);
});
...
break;
default:
var G__29941 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29941;
continue;
...
var n__29334__auto___29942 = a.length;
var i_29943 = (0);
while(true){
if((i_29943 < n__29334__auto___29942)){
(a[i_29943] = reagent.impl.template.as_element.call(null,(a[i_29943])));

var G__29944 = (i_29943 + (1));
i_29943 = G__29944;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29334__auto___29945 = a.length;
var i_29946 = (0);
while(true){
if((i_29946 < n__29334__auto___29945)){
var val_29947 = (a[i_29946]);
if((cljs.core.vector_QMARK_.call(null,val_29947)) && ((reagent.impl.template.key_from_vec.call(null,val_29947) == null))){
(o["no-key"] = true);
} else {
}

(a[i_29946] = reagent.impl.template.as_element.call(null,val_29947));

var G__29948 = (i_29946 + (1));
i_29946 = G__29948;
continue;
} else {
}
...
var ctx = {};
var vec__29950 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__29950,(0),null);
var derefed = cljs.core.nth.call(null,vec__29950,(1),null);
...
var G__29952 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29952) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__29952){
