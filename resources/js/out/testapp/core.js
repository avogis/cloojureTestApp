...
console.log(cljs.core.nth.call(null,(cljs.core.deref.call(null,testapp.core.current_method)["arr"]),(1)));

return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.nth.call(null,(cljs.core.deref.call(null,testapp.core.current_method)["arr"]),(1))], null);
});
testapp.core.handler = (function testapp$core$handler(response){
console.log("!!!!",cljs.core.nth.call(null,(response["arr"]),(1)));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"onClick","onClick",-1991238530),testapp.core.get_new_method], null),"New method"], null);
});
